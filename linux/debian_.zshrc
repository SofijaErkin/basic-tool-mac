...
# You can install custom themes to ~/.oh-my-zsh/themes/ and configure ~/.zshrc to
# use it. Modify theme variable name to ZSH_THEME.
ZSH_THEME="ys"
# ZSH_THEME="spaceship" # Not found
#ZSH_THEME=agnoster
...
#inpute .py under zsh and auto open by Vim
alias -s py=vim
alias -s conf=vim
# auto-unzip or auto-tar for a tgz file
